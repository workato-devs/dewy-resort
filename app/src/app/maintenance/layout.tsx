...
/**
 * Maintenance Portal Layout
 * Provides navigation and layout structure for maintenance staff pages
 */
...
const navigationItems = [
  ...
  { name: 'Work Orders', href: '/maintenance/work-orders', icon: Wrench },
  { name: 'AI Assistant', href: '/maintenance/chat', icon: MessageSquare },
];
...
export default function MaintenanceLayout({
  ...
  // Redirect if not authenticated or not maintenance staff
  useEffect(() => {
    if (!loading && (!user || user.role !== 'maintenance')) {
      router.push('/login');
    }
  }, [user, loading, router]);
    ...
    <div className="min-h-screen bg-gray-50 dark:bg-gray-950">
      ...
      <header className="lg:hidden bg-white dark:bg-gray-900 border-b border-gray-200 dark:border-gray-800 sticky top-0 z-40">
        <div className="flex items-center justify-between px-4 py-3">
          <div>
            <h1 className="text-lg font-semibold text-gray-900 dark:text-gray-100">Maintenance Portal</h1>

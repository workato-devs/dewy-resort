/**
 * Guest Chat API
 * GET /api/guest/chat - Fetch message history
 * POST /api/guest/chat - Send message and get AI response
 */
...
import { processGuestChatMessage } from '@/lib/chat/guest-intents';

/**
 * GET /api/guest/chat
 * Fetch chat message history for the authenticated guest
 */
...
export async function POST(request: NextRequest) {
  try {
    ...
    const aiResponse = await processGuestChatMessage(content.trim(), user);

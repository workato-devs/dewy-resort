...
1. Start with [Pre-Workshop Setup](docs/units/01-pre-workshop.html) to prepare your accounts
2. Follow the [Workshop Units](docs/units/) in order during the session
3. Reference the [Guides](docs/guides/) for troubleshooting

### For Facilitators

1. Review the [Facilitator Checklist](docs/guides/facilitator-checklist.html)
2. Toggle to Facilitator Mode using the button in the top-right
3. Facilitator notes appear throughout the unit content

---

## Key Resources

- **Workshop Repository:** [github.com/workato-devs/dewy-resort](https://github.com/workato-devs/dewy-resort)
